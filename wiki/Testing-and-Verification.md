...
5. Stable one-to-one identity for all 28 dance moves and complete 24-trick catalog coverage.

The tests use uniquely identified Forge fake players and a real `ServerLevel` rather than mocked movement classes. Unique profiles prevent parallel GameTests from moving or mutating the same automation player.
