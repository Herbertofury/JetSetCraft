...
/**
 * One source of truth for bundled graffiti. The generated catalog preserves each source tag's native
 * aspect ratio while entities synchronize only a stable integer index.
 */
